...
Legal, ethical, and data-handling expectations for **Heart Failure Clinical Records**.
...
| Source | Notes |
|--------|-------|
| Primary dataset | UCI Heart Failure Clinical Records (dataset 519) - review UCI terms |
