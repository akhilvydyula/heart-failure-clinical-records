# Contributing to Heart Failure Clinical Records

Thank you for helping improve **Heart Failure Clinical Records**! This project is part of the
...
```bash
git clone https://github.com/akhilvydyula/heart-failure-clinical-records.git
cd heart-failure-clinical-records
python -m venv .venv
...
- [GitHub Discussions](https://github.com/akhilvydyula/heart-failure-clinical-records/discussions) for Q&A
